    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "862146707236334",
               appSecret: "83dcfcf58da0020c8d720b11e20770e5");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "297243899206-cknl7ev5sp6onqthiljacnm9112dtpdb.apps.googleusercontent.com",
                ClientSecret = "Wxxqjj1-c7GzaR-R_akSjheM"
            });
        }
    }
}